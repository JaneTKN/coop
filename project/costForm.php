...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "costform")) {
  $insertSQL = sprintf("INSERT INTO forcost (NoidNo, foreng1, foreng2, foreng3, foreng4, foreng5, engApprove1, engdate1, price1, price2, price3, engApprove2, engdate2,engApprove0, engdate0, toManager, manager, managerdate) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['no'], "text"),
                       GetSQLValueString($_POST['foreng1'], "text"),
                       GetSQLValueString($_POST['foreng2'], "text"),
                       GetSQLValueString($_POST['foreng3'], "text"),
                       GetSQLValueString($_POST['foreng4'], "text"),
                       GetSQLValueString($_POST['foreng5'], "text"),
                       GetSQLValueString($_POST['engApprove1'], "text"),
                       GetSQLValueString($_POST['engdate1'], "text"),
                       GetSQLValueString($_POST['price1'], "text"),
                       GetSQLValueString($_POST['price2'], "text"),
                       GetSQLValueString($_POST['price3'], "text"),
                       GetSQLValueString($_POST['engApprove2'], "text"),
                       GetSQLValueString($_POST['engdate2'], "text"),
					   GetSQLValueString($_POST['engApprove0'], "text"),
                       GetSQLValueString($_POST['engdate0'], "text"),
                       GetSQLValueString($_POST['toManager'], "text"),
					   GetSQLValueString($_POST['manager'], "text"),
                       GetSQLValueString($_POST['managerdate'], "text"));
...
<img src="img/logo_detail.jpg" />
	<center><table border="2" width="50%" bgcolor="#FAA575">
	  ...
	  <caption> <font size = "5"><b>ใบสอบถามราคาต้นทุน<br>
	  </caption></font></b>
  <tr><td colspan="2"><input type="hidden" name="formtype" value="แบบสอบถามราคาต้นทุน" >
...
<!row4 guaruntee>
			<tr>
				...
				<input name="gua" type="radio" id="gua" value="พิเศษ"> พิเศษ
				<!table in>
				<table border="1" width="100%">
					<tr>
...
<!row12 forcost>
			<tr>
				<td><center><b>สำหรับขอต้นทุน</td>
				<td>
					<table border="1">
						<tr>
							<td>
								<b>สำหรับฝ่ายวิศวกรรม </b><br>
								<input type="checkbox" name="foreng1" value="มีเอกสารต้นทุนแล้วเลขที่"> มีเอกสารต้นทุนแล้วเลขที่ <input type="text" name="costno" size="15"><br>
								<input type="checkbox" name="foreng2" value="จัดทำเอกสารต้นทุน 1 และ 2"> จัดทำเอกสารต้นทุน 1 และ 2 <br>
								<input type="checkbox" name="foreng3" value="จัดทำเฉพาะเอกสารต้นทุนที่ 2"> จัดทำเฉพาะเอกสารต้นทุนที่ 2 <br>
								<input type="checkbox" name="foreng4" value="ปรับราคาเอกสารต้นทุนเลขที่"> ปรับราคาเอกสารต้นทุนเลขที่ <br>
								<input type="checkbox" name="foreng5" value="ไม่จัดทำเพราะ"> ไม่จัดทำเพราะ <input type="text" name="cause" size="50"> <br>
								ผู้อนุมัติ <input type="text" name="engApprove1" size="15"> <a href="javascript:displayDatePicker('engdate1')"><input name="engdate1" placeholder="วัน/เดือน/ปี"></a><br>
								&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp(หผ.เทคนิค)
							</td>
							<td>
								<b>สำหรับฝ่ายผู้ขอราคา</b><br>
								สอบถามราคาต้นทุนเพื่อ <br>
								<input type="checkbox" name="price1" value="เสนอประมูลราคา"> เสนอประมูลราคา <br>
								<input type="checkbox" name="price2" value="เพื่อแข่งขันราคา"> เพื่อแข่งขันราคา <br>
								<input type="checkbox" name="price3" value="อื่นๆ"> อื่นๆ <input type="text" name="other12" size="30"><br>
								ลงชื่อ <input type="text" name="engApprove2" size="15"> <a href="javascript:displayDatePicker('engdate2')"><input name="engdate2" placeholder="วัน/เดือน/ปี"></a><br>
								&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp(ผู้ขอราคา)<br>
                                ลงชื่อ <input type="text" name="engApprove0" size="15"> <a href="javascript:displayDatePicker('engdate0')"><input name="engdate0" placeholder="วัน/เดือน/ปี"></a><br>
								&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp(ผู้จัดการฝ่ายขอราคา)
							</td>
						</tr>
						<tr>
							<td colspan="2">เรียน  กรรมการผู้จัดการ  ได้จัดทำราคาต้นทุนของผลิตภัณฑ์ข้างต้น และแนบมาพร้อมกันแล้ว <input type="text" name="toManager" size="150"><br />
                            ผู้จัดการฝ่ายวิศวกรรม <input type="text" name="manager" size="15"> <a href="javascript:displayDatePicker('managerdate')"><input name="managerdate" placeholder="วัน/เดือน/ปี"></a><br>
							<td>
						</tr>
					</table>
				</td>
	...
	<br>
	<br>
	<input name="submit" type="submit" class="button button5" style="width: 200px" onKeyPress="return keyPressed(event)" value="Submit">
	<input name="reset" type="reset" class="button button5" style="width: 200px" value="Reset">
