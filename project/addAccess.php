...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO accessorytool (accessorytoolid, accname) VALUES (%s, %s)",
                       GetSQLValueString($_POST['accessorytoolid'], "int"),
...
mysql_select_db($database_dbconnect, $dbconnect);
$query_Recordset1 = "SELECT * FROM accessorytool";
...
<p>&nbsp;</p>
  <div align="center">
    <h2>เพิ่มข้อมูล ACCESSORY</h2>
    <table align="center">
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Accessory:</td>
...
<div align="center" >
  <table border="1" width="500px">
    ...
    <?php do { ?>
      <tr>
        <td><div align="center" id="accname"><?php echo $row_Recordset1['accname']; ?></div></td>
        <td><div align="center"><a href="delete.php?accname=<?php echo $row_Recordset1['accname']; ?>" onClick="return chkdel();">DELETE</a></div></td>
      </tr>
