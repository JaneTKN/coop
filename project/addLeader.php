...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO leader (leadername) VALUES (%s)",
                       GetSQLValueString($_POST['leadername'], "text"));
...
mysql_select_db($database_dbconnect, $dbconnect);
$query_Recordset1 = "SELECT * FROM leader";
...
function fncSubmit()
{
	if(document.form1.leadername.value == "")
	{
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" onsubmit="Javascript:return fncSubmit();">
  <h2 align="center">เพิ่มข้อมูลชนิดตัวนำ</h2>
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">ชนิดตัวนำ : </td>
      <td><input type="text" name="leadername" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
  ...
  <div align="center">
    <table width="300" border="1">
      ...
      <?php do { ?>
        <tr>
          <td><div align="center" id="leadername"><?php echo $row_Recordset1['leadername']; ?></div></td>
          <td><div align="center"><a href="delete.php?leadername=<?php echo $row_Recordset1['leadername']; ?>" onClick="return chkdel();">DELETE</a></div></td>
        </tr>
