...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO road (roadname) VALUES (%s)",
                       GetSQLValueString($_POST['roadname'], "text"));
...
mysql_select_db($database_dbconnect, $dbconnect);
$query_Recordset1 = "SELECT * FROM road";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <h2 align="center">เพิ่มข้อมูลถนน</h2>
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">ROAD : </td>
      <td><input type="text" name="roadname" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
  ...
  <div align="center">
    <table width="300" border="1">
      ...
      <?php do { ?>
        <tr>
          <td><div align="center" id="roadname"><?php echo $row_Recordset1['roadname']; ?></div></td>
          <td><div align="center"><a href="delete.php?roadname=<?php echo $row_Recordset1['roadname']; ?>" onClick="return chkdel();">DELETE</a></div></td>
        </tr>
